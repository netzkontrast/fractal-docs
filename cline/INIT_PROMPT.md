...
### 2. Create .clinerules/ Rule Files

#### 2.1 Create `.clinerules/doc-maintenance.md`
...
#### 2.2 Create `.clinerules/project-structure.md`
...
{List core directories and their README.md paths based on the analysis results}
```
