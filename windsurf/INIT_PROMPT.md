...
### 2. Create .windsurf/rules/ Rule Files

#### 2.1 Create `.windsurf/rules/doc-maintenance.md`
...
#### 2.2 Create `.windsurf/rules/project-structure.md`
...
{List core directories based on the analysis results}
```
